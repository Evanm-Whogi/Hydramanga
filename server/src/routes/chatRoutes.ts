...
import { chatMessageRateLimit, chatMutationRateLimit } from '@/middlewares/userActionRateLimit';
...
router.patch('/messages/:messageId', authMiddleware, chatMutationRateLimit, updateChatMessage as RequestHandler);
router.delete('/messages/:messageId', authMiddleware, chatMutationRateLimit, deleteChatMessage as RequestHandler);
