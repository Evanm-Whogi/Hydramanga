...
router.post('/:id/chapter/:chapterId/bookmark', authMiddleware, addBookmark as RequestHandler);
router.delete('/:id/chapter/:chapterId/bookmark', authMiddleware, removeBookmark as RequestHandler);
