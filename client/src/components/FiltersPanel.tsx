  ...
  return (
    <div className="flex flex-col gap-2 md:gap-3 w-full">
      <div className="flex gap-6 items-end flex-wrap">
        ...
        <button onClick={handleNsfwToggle} className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors whitespace-nowrap cursor-pointer ${nsfwButtonClass}`} aria-label={`Toggle NSFW content - currently ${isNsfwEnabled ? 'enabled' : 'disabled'}`}>
