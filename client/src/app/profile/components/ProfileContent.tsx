"use client";
import { FlagTriangleRight, LayoutDashboardIcon, SettingsIcon, UserPlusIcon, Share2 } from 'lucide-react';
  ...
  return (
    <>
      <div
        ...
        style={{ '--manga-cover': `url(${user?.image})` } as React.CSSProperties}
      ></div>
