          ...
          <div className="flex flex-col w-full md:w-1/4 p-5 space-y-2">
            ...
            {/* <div className="flex gap-3">
              <button
                ...
                disabled={loading}
                className="p-3 mt-5 bg-foreground text-primary hover:bg-foreground/50 hover:cursor-pointer rounded-lg w-1/2 inline-flex items-center justify-center"
              >
                <Image
                  src="/oauthIcons/googleLogo.png"
                  alt="google"
                  width="64"
                  height="64"
              ...
              >
                <Image
                  src="/oauthIcons/discordLogo.png"
                  alt="discord"
                  width="64"
                  height="64"
